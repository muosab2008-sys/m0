      ...
      (snapshot) => {
        const data = snapshot.docs.map((doc) => {
          ...
          return {
            ...
            username: d.username,
            email: d.email,
            points: d.points || d.account_balance || 0,
            fragments: d.fragments || 0,
            level: d.level || 1,
            totalEarned: d.totalEarned || 0,
            isAdmin: d.isAdmin || false,
            isBanned: d.isBanned || false,
            createdAt: d.createdAt?.toDate?.() || new Date(d.reg_time * 1000) || new Date(),
            country: d.country,
          };
        }) as User[];
        setUsers(data);
                ...
                >
                  <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    <div className="flex-1 space-y-1">
                      ...
                      {user.country && (
                        <p className="text-xs text-white/40">Country: {user.country}</p>
                      )}
                    </div>
