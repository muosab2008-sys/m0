...
export default function AdminPromoPage() {
  ...
  const totalPointsGiven = promoCodes.reduce((acc, code) => acc + (code.pointsReward * code.usesCount), 0);
  const totalFragmentsGiven = promoCodes.reduce((acc, code) => acc + (code.fragmentsReward * code.usesCount), 0);
  const totalRedemptions = promoCodes.reduce((acc, code) => acc + code.usesCount, 0);
      ...
      <div className="grid gap-4 sm:grid-cols-4">
        <Card className="border-white/5 bg-[#0a0a0a] rounded-2xl">
          <CardContent className="p-5 text-center">
            <p className="text-3xl font-black text-[#3B82F6]">{promoCodes.length}</p>
            <p className="text-sm text-white/50">Total Codes</p>
          </CardContent>
        </Card>
        <Card className="border-white/5 bg-[#0a0a0a] rounded-2xl">
          <CardContent className="p-5 text-center">
            <p className="text-3xl font-black text-emerald-500">{totalRedemptions}</p>
            <p className="text-sm text-white/50">Total Redemptions</p>
          </CardContent>
        </Card>
        <Card className="border-white/5 bg-[#0a0a0a] rounded-2xl">
          <CardContent className="p-5 text-center">
            <p className="text-3xl font-black text-amber-500">{totalPointsGiven.toLocaleString()}</p>
            <p className="text-sm text-white/50">Points Given</p>
          </CardContent>
        </Card>
        <Card className="border-white/5 bg-[#0a0a0a] rounded-2xl">
          <CardContent className="p-5 text-center">
            <p className="text-3xl font-black text-[#8B5CF6]">{totalFragmentsGiven.toLocaleString()}</p>
            <p className="text-sm text-white/50">Fragments Given</p>
          </CardContent>
        </Card>
      </div>
